...
class AdversarialEliteTests(unittest.TestCase):
    def _load(self):
        errors = []
        for name in ('open_model_fidelity_passport', "src." + 'open_model_fidelity_passport'):
            try:
    ...
    def test_refuse_bad_import_path_does_not_shadow(self):
        with self.assertRaises(ModuleNotFoundError):
            importlib.import_module("src.__elite_does_not_exist_" + 'open_model_fidelity_passport')
